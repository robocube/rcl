...
namespace RCL.Test
{
  ...
  public class LexerTest
  {
    ...
    public void TestByteLiterals ()
    {
      ...
      CheckTypes (tokens, RCTokenType.Literal, RCTokenType.WhiteSpace, RCTokenType.Literal, RCTokenType.WhiteSpace, RCTokenType.Literal);
    }
    ...
    public void TestNumbers ()
    {
      ...
      CheckTypes (tokens, RCTokenType.Number, RCTokenType.WhiteSpace, RCTokenType.Number, RCTokenType.WhiteSpace, RCTokenType.Number);
    }
    ...
    public void TestQuotedSymbols ()
    {
      ...
      CheckTypes (tokens, RCTokenType.Symbol, RCTokenType.WhiteSpace, RCTokenType.Symbol, RCTokenType.WhiteSpace, RCTokenType.Symbol);
    }
    ...
    public void TestAnonymousBlocks ()
    {
      ...
      CheckTypes(tokens, RCTokenType.Block, RCTokenType.Evaluator, RCTokenType.Number, RCTokenType.WhiteSpace, RCTokenType.Evaluator, RCTokenType.Boolean, RCTokenType.WhiteSpace, RCTokenType.Evaluator, RCTokenType.String, RCTokenType.Block);
    }
    ...
    public void TestNamedBlocks ()
    {
      ...
      CheckTokens(tokens, "{", "number", ":", "23", " ", "boolean", ":", "true", " ", "string", ":", "\"this is a string\"", "}" );
      CheckTypes(tokens, RCTokenType.Block, RCTokenType.Name, RCTokenType.Evaluator, RCTokenType.Number, RCTokenType.WhiteSpace, RCTokenType.Name, RCTokenType.Evaluator, RCTokenType.Boolean, RCTokenType.WhiteSpace, RCTokenType.Name, RCTokenType.Evaluator, RCTokenType.String, RCTokenType.Block);
    }

    [Test]
    public void TestMixingNestedNamedAndAnonymousBlocks ()
    {
      RCArray<RCToken> tokens = Lex("{number:23 :true nestedBlock:{nestedString:\"aNestedString\"}string:\"a string\"}");
      CheckTokens(tokens, "{", "number", ":", "23", " ", ":", "true", " ", "nestedBlock", ":", "{", "nestedString", ":", "\"aNestedString\"", "}", "string", ":", "\"a string\"", "}" );
      CheckTypes(tokens, RCTokenType.Block, RCTokenType.Name, RCTokenType.Evaluator, RCTokenType.Number, RCTokenType.WhiteSpace, RCTokenType.Evaluator, RCTokenType.Boolean, RCTokenType.WhiteSpace, RCTokenType.Name, RCTokenType.Evaluator, RCTokenType.Block, RCTokenType.Name, RCTokenType.Evaluator, RCTokenType.String, RCTokenType.Block, RCTokenType.Name, RCTokenType.Evaluator, RCTokenType.String, RCTokenType.Block);
    }
    ...
    public void TestOperator ()
    {
      ...
      CheckTypes(tokens, RCTokenType.Name, RCTokenType.Block, RCTokenType.Name, RCTokenType.Evaluator, RCTokenType.Boolean, RCTokenType.WhiteSpace, RCTokenType.Name, RCTokenType.Evaluator, RCTokenType.Boolean, RCTokenType.Block);
    }
    ...
    public void TestNestedOperator ()
    {
      ...
      CheckTokens(tokens, "or", "{", "left", ":", "and", "{", "left", ":", "true", " ", "right", ":", "true", "}", "right", ":", "false", "}" );
      CheckTypes(tokens, RCTokenType.Name, RCTokenType.Block, RCTokenType.Name, RCTokenType.Evaluator, RCTokenType.Name, RCTokenType.Block, RCTokenType.Name, RCTokenType.Evaluator, RCTokenType.Boolean, RCTokenType.WhiteSpace, RCTokenType.Name, RCTokenType.Evaluator, RCTokenType.Boolean, RCTokenType.Block, RCTokenType.Name, RCTokenType.Evaluator, RCTokenType.Boolean, RCTokenType.Block);
    }
    ...
    public void TestBackslashInStringToken ()
    {
      ...
      CheckTypes(tokens, RCTokenType.Block, RCTokenType.Name, RCTokenType.Evaluator, RCTokenType.String, RCTokenType.WhiteSpace, RCTokenType.Name, RCTokenType.Evaluator, RCTokenType.String, RCTokenType.Block);
    }
    ...
    public void Test3Spacers ()
    {
      RCArray<RCToken> tokens = Lex("--- --- ---");
      CheckTokens(tokens, "---", " ", "---", " ", "---" );
      CheckTypes(tokens, RCTokenType.Spacer, RCTokenType.WhiteSpace, RCTokenType.Spacer, RCTokenType.WhiteSpace, RCTokenType.Spacer);
    }
    ...
    public void TestDashNotAllowedInNames ()
    {
      ...
      CheckTypes(tokens, RCTokenType.Name, RCTokenType.Name, RCTokenType.Name, RCTokenType.Name, RCTokenType.Name);
    }
    ...
    public void TestQuotedName ()
    {
      ...
      CheckTypes (tokens, RCTokenType.Block, RCTokenType.Name, RCTokenType.Evaluator, RCTokenType.Number, RCTokenType.WhiteSpace, RCTokenType.Number, RCTokenType.WhiteSpace, RCTokenType.Number, RCTokenType.Block);
    }
