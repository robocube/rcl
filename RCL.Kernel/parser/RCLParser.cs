...
namespace RCL.Kernel
{
  ...
  public static class RCSystem
  {
    ...
    private static RCLArgv m_argv;
    private static RCLog m_log;
    private static RCActivator m_activator;

    public static void Init (RCLArgv argv, RCLog log, RCActivator activator)
    {
      if (m_initialized)
      {
        throw new Exception ("RCSystem is already initialized");
      }
      m_argv = argv;
      m_log = log;
    ...
    public static RCLArgv Argv
    {
      get { return m_argv; }
    }

    public static RCLog Log
    {
      get { return m_log; }
    }
