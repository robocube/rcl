...
{
  /// <summary>
  /// A runtime exception in an RCL user program. RCExceptions occur in both debug and
  /// release builds. Additionally, all RCExceptions have closures attached, whereas
  /// RCDebugExceptions do not.
  /// </summary>
  [Serializable]
  public class RCException : Exception
  {
    protected static string MONADIC_OVERLOAD_FORMAT =
      "Operator {0} cannot receive a single argument of type {1}";
    protected static string DYADIC_OVERLOAD_FORMAT =
      "Operator {0} cannot receive arguments of type {2} and {1}";
    ...
    {
      return ToStringInner (testString: false,
                            messageOnTop: false,
                            noStackOnNonNativeErrors: false,
                            firstOnTop: true);
    }
    ...
    {
      return ToStringInner (testString: !RCSystem.Args.FullStack,
                            messageOnTop: false,
                            noStackOnNonNativeErrors: false,
                            firstOnTop: true);
    }

    public string ToStringInner (bool testString,
                                 bool messageOnTop,
                                 bool noStackOnNonNativeErrors,
                                 bool firstOnTop)
    {
