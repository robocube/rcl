...
namespace RCL.Core
{
  ...
  {
    [RCVerb ("alternate")]
    public void EvalAlternate (RCRunner runner, RCClosure closure, RCByte left, RCByte right)
    {
      runner.Yield (closure, new RCByte (DoAlternate<byte> (left, right)));
    }

    [RCVerb ("alternate")]
    public void EvalAlternate (RCRunner runner, RCClosure closure, RCLong left, RCLong right)
    {
      runner.Yield (closure, new RCLong (DoAlternate<long> (left, right)));
    }

    [RCVerb ("alternate")]
    public void EvalAlternate (RCRunner runner, RCClosure closure, RCDouble left, RCDouble right)
    {
      runner.Yield (closure, new RCDouble (DoAlternate<double> (left, right)));
    }

    [RCVerb ("alternate")]
    public void EvalAlternate (RCRunner runner, RCClosure closure, RCDecimal left, RCDecimal right)
    {
      runner.Yield (closure, new RCDecimal (DoAlternate<decimal> (left, right)));
    }

    [RCVerb ("alternate")]
    public void EvalAlternate (RCRunner runner, RCClosure closure, RCBoolean left, RCBoolean right)
    {
      runner.Yield (closure, new RCBoolean (DoAlternate<bool> (left, right)));
    }

    [RCVerb ("alternate")]
    public void EvalAlternate (RCRunner runner, RCClosure closure, RCString left, RCString right)
    {
      runner.Yield (closure, new RCString (DoAlternate<string> (left, right)));
    }

    [RCVerb ("alternate")]
    public void EvalAlternate (RCRunner runner, RCClosure closure, RCSymbol left, RCSymbol right)
    {
      runner.Yield (closure, new RCSymbol (DoAlternate<RCSymbolScalar> (left, right)));
    }

    [RCVerb ("alternate")]
    public void EvalAlternate (RCRunner runner, RCClosure closure, RCTime left, RCTime right)
    {
