...
namespace RCL.Core
{
  ...
  {
    [RCVerb ("shuffle")]
    public void EvalShuffle (RCRunner runner, RCClosure closure, RCByte right)
    {
    ...
    [RCVerb ("shuffle")]
    public void EvalShuffle (RCRunner runner, RCClosure closure, RCLong right)
    {
      runner.Yield (closure, new RCLong (DoShuffle<long> (new Random (), right)));
    }

    [RCVerb ("shuffle")]
    public void EvalShuffle (RCRunner runner, RCClosure closure, RCLong left, RCLong right)
    {
      runner.Yield (closure, new RCLong (DoShuffle<long> (new Random ((int) left[0]), right)));
    }

    [RCVerb ("shuffle")]
    public void EvalShuffle (RCRunner runner, RCClosure closure, RCDouble right)
    {
    ...
    [RCVerb ("shuffle")]
    public void EvalShuffle (RCRunner runner, RCClosure closure, RCDecimal right)
    {
    ...
    [RCVerb ("shuffle")]
    public void EvalShuffle (RCRunner runner, RCClosure closure, RCString right)
    {
    ...
    [RCVerb ("shuffle")]
    public void EvalShuffle (RCRunner runner, RCClosure closure, RCBoolean right)
    {
    ...
    [RCVerb ("shuffle")]
    public void EvalShuffle (RCRunner runner, RCClosure closure, RCSymbol right)
    {
      runner.Yield (closure, new RCSymbol (DoShuffle<RCSymbolScalar> (new Random (), right)));
    }

    [RCVerb ("shuffle")]
    public void EvalShuffle (RCRunner runner, RCClosure closure, RCLong left, RCSymbol right)
    {
      runner.Yield (closure,
                    new RCSymbol (DoShuffle<RCSymbolScalar> (new Random ((int) left[0]),
                                                             right)));
    }

    [RCVerb ("shuffle")]
    public void EvalShuffle (RCRunner runner, RCClosure closure, RCTime right)
    {
    ...
    [RCVerb ("shuffle")]
    public void EvalShuffle (RCRunner runner, RCClosure closure, RCBlock right)
    {
      runner.Yield (closure, DoShuffle (new Random (), right));
    }

    [RCVerb ("shuffle")]
    public void EvalShuffle (RCRunner runner, RCClosure closure, RCLong left, RCBlock right)
    {
