...
namespace RCL.Core
{
  public class Inter
  {
    ...
    [RCVerb ("inter")]
    public void EvalInter (RCRunner runner, RCClosure closure, RCString left, RCString right)
    {
    ...
    [RCVerb ("inter")]
    public void EvalInter (RCRunner runner, RCClosure closure, RCBlock left, RCString right)
    {
