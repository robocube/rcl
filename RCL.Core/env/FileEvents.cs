...
namespace RCL.Core
{
  public class FileEvents
  {
    ...
    protected Dictionary <long, RCLFileSystemWatcher> m_watchers = new Dictionary<long, RCLFileSystemWatcher> ();
    ...
    {
      RCBlock result = RCBlock.Empty;
      result = new RCBlock (result, "event", ":", new RCString (e.ChangeType.ToString ().ToLower ()));
