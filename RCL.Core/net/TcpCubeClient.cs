...
namespace RCL.Core
{
  public class TcpCubeClient : Tcp.Client
  {
      ...
      RCRunner runner, RCClosure closure, RCBlock message)
    {
      ...
      else throw new Exception ("Unknown verb:" + verb);
    }

    protected virtual void WriteToFiles (
      RCRunner runner, RCClosure closure, RCValue val) //RCCube cube)
    {

    }

    protected virtual void WriteToFiles (
      RCRunner runner, RCClosure closure, RCSymbol symbol, RCBlock data)
    {
    ...
    protected virtual void ReadFromFiles (
      RCRunner runner, RCClosure closure, RCSymbol symbol, RCLong rows)
    {
